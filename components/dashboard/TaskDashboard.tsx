...
export const TaskDashboard: React.FC<TaskDashboardProps> = ({
  ...
  return (
    <div className="w-full flex-1 flex flex-col font-sans pb-12">
      {/* Top Header & Monthly Report Trigger */}
      <div className="bg-zinc-900/60 border border-white/[0.06] rounded-xl p-4 sm:p-5 mb-6 shadow-sm">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-zinc-800 border border-white/[0.1] flex items-center justify-center text-zinc-300">
              <LayoutDashboard className="w-4 h-4" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs text-zinc-400 font-medium">
                  Productividad • {currentUser.role === 'admin' ? 'Administrador' : 'Colaborador'}
                </span>
              </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-white hover:bg-zinc-200 text-zinc-950 px-3.5 py-2 rounded-lg text-xs font-medium shadow-sm transition-all active:scale-[0.98]"
          >
        ...
        <div className="mt-4 pt-3.5 border-t border-white/[0.06] flex flex-col md:flex-row md:items-center justify-between gap-3">
          {/* Quick Date Filters */}
          <div className="flex items-center gap-1 overflow-x-auto no-scrollbar p-0.5 bg-zinc-950/60 rounded-lg border border-white/[0.06]">
            {(
              [
                { id: 'today', label: 'Hoy' },
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-md text-xs font-medium whitespace-nowrap transition-all active:scale-[0.98] ${
                  quickFilter === f.id
